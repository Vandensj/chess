...
public class PawnMoveTests {
    ...
    public void pawnMiddleOfBoardWhite() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(4, 4), new int[][]{{5, 4}});
    }
    ...
    public void pawnMiddleOfBoardBlack() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(4, 4), new int[][]{{3, 4}});
    }
    ...
    public void pawnInitialMoveWhite() {
        validateMoves("""
                ...
                | | | | |P| | | |
                | | | | | | | | |
                """, new ChessPosition(2, 5), new int[][]{{3, 5}, {4, 5}});
    }
    ...
    public void pawnInitialMoveBlack() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(7, 3), new int[][]{{6, 3}, {5, 3}});
    }
    ...
    public void pawnPromotionWhite() {
        validatePromotion("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(7, 3), new int[][]{{8, 3}});
    }
    ...
    public void edgePromotionBlack() {
        validatePromotion("""
                ...
                | | |p| | | | | |
                | | | | | | | | |
                """, new ChessPosition(2, 3), new int[][]{{1, 3}});
    }
    ...
    public void pawnPromotionCapture() {
        validatePromotion("""
                ...
                | |p| | | | | | |
                |N| | | | | | | |
                """, new ChessPosition(2, 2), new int[][]{{1, 1}, {1, 2}});
    }
    ...
    public void pawnAdvanceBlockedDoubleMoveWhite() {
        validateMoves("""
                ...
                | | | | | | |P| |
                | | | | | | | | |
                """, new ChessPosition(2, 7), new int[][]{{3, 7}});
    }
    ...
    public void pawnCaptureWhite() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(4, 4), new int[][]{{5, 3}, {5, 4}});
    }
    ...
    public void pawnCaptureBlack() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(4, 4), new int[][]{{3, 5}});
    }
