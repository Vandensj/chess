...
public class KnightMoveTests {
    ...
    public void knightEdgeOfBoardLeft() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(4, 1), new int[][]{{6, 2}, {5, 3}, {3, 3}, {2, 2}});
    }
    ...
    public void knightEdgeOfBoardRight() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(3, 8), new int[][]{{1, 7}, {2, 6}, {4, 6}, {5, 7}});
    }
    ...
    public void knightEdgeOfBoardBottom() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | |N| | |
                """, new ChessPosition(1, 6), new int[][]{{2, 4}, {3, 5}, {3, 7}, {2, 8}});
    }
    ...
    public void knightEdgeOfBoardTop() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(8, 3), new int[][]{{7, 5}, {6, 4}, {6, 2}, {7, 1}});
    }
    ...
    public void knightCornerOfBoardBottomRight() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | |N|
                """, new ChessPosition(1, 8), new int[][]{{2, 6}, {3, 7}});
    }
    ...
    public void knightCornerOfBoardTopRight() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(8, 8), new int[][]{{6, 7}, {7, 6}});
    }
    ...
    public void knightCornerOfBoardTopLeft() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(8, 1), new int[][]{{7, 3}, {6, 2}});
    }
    ...
    public void knightCornerOfBoardBottomLeft() {
        validateMoves("""
                ...
                | | | | | | | | |
                |n| | | | | | | |
                """, new ChessPosition(1, 1), new int[][]{{2, 3}, {3, 2}});
    }
    ...
    public void knightBlocked() {
        validateMoves("""
                ...
                | | | | | | | | |
                | | | | | | | | |
                """, new ChessPosition(5, 5), new int[][]{{3, 4}, {3, 6}, {4, 7}, {7, 6}, {6, 3}});
    }
